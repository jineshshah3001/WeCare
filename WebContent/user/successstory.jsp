...
<div class="container_12">
    <div class="grid_12" style="margin-bottom: -35px; margin-top: 20px;">
      ...
      <h1 class="">
      <a:set var="val1" value="${sessionScope.ein}"></a:set>
	  <a:set var="val2" value="${sessionScope.uid}"></a:set>
	 <a:if test="${val1 == null && val2 == null}">
      ...
      <a href="home_org.jsp" style="font-size: 75%;">
       ...
       <a:if test="${val2 != null}">
      <a style="margin-top:10%" href="index1.jsp" style="font-size: 75%;">
          WeCare
       </a>
       </a:if>
...
<section id="content" style="height:700px"><div class="ic">More Website Templates @ TemplateMonster.com - September22, 2014!</div>
  ...
  <!-- <form action="../AdminController" method="post">
   ...
   <div class="text1" style="margin-top:10%; margin-left:80%"><form>
  
   <button formaction="<%=request.getContextPath() %>/user/addsuccessstory.jsp">Add Your Own User Stories</a></form>       </div>
