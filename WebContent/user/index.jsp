...
<!--        <button id ="modalClose" class="btn btn-success" onclick="document.getElementById('id10').style.display='block'" style="width:20%; margin-left:61%; margin-top:-12%">Subscribe for NGOs</button>
 -->   
    </div> 
...
<div id="id10" class="modal1">
  ...
  <div class="modal-content1 animate" align="center" >
 	<form action="../guestservletcontroller" method="post">
...
-->
    ...
    <div class="container" >
      ...
      <input style="color:black" type="password" placeholder="Enter Password" name="password" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
  ...
  <form class="modal-content animate" action="../userController" method="post">
    ...
    <div class="container">
      ...
      <input style="color:black" type="text" placeholder="Enter Email" name="user_email"  pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,3}$" title="Invalid email address." required>
        ...
        <label style="color:black" for="psw"><b>Password</b></label>
      <input style="color:black" type="password" placeholder="Enter Password" name="user_psw" pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" title="Must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters"
...
Things</a>
   ...
   <div class="container_12">
    <div class="grid_6" style="margin-left:40px; margin-top:-100px">
      <div class="block-2">
        <img src="images/subscribe.png" alt="">
        <div class="text1"><a href="../guestsubscriptionController">Subscribe Here</a></div>
      </div>
    </div>
...
<%--         <div class="text1"><a href="<%=request.getContextPath() %>/user/addsuccessstory.jsp">User Stories</a></div>
 --%>      </div>
    </div>
    <div class="clear"></div>
  </div> 
 <!--  <div class="clear sep-1"></div>
  <article class="carousel_wrapper" style="margin-top:-229px">
    <div class="container_12">
      <div class="grid_12">
        <div id="owl">
          <div class="item">
            <div class="banner">
              <div class="banner_title" style="height:">July 25</div>
