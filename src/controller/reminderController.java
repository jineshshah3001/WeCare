...
import controller.sendEventConfirmation;
...
//        sendConfirmation.send(user_email, event_name);
...
//				rm.setReminderkey(rmk);
                ...
                String details=event_name+","+event_date;
                sendEventConfirmation.send(user_email, details);
